...
function App() {
  ...
  const routes = [
    ...
    { path: Routes.CustomersList, name: 'Customers', component: <L.CustomersList actions={actions} customers={customers} /> },
    { path: Routes.CustomersCreate, name: 'New Customer', component: <L.CustomersEditor actions={actions} /> },
    { path: Routes.CustomersEdit, name: 'Edit Customer', component: <L.CustomersEditor actions={actions} customers={customers} /> },
    { path: Routes.ItemsList, name: 'Items', component: <L.ItemsList actions={actions} items={items} /> },
    { path: Routes.ItemsCreate, name: 'New Item', component: <L.CreateItem actions={actions} /> },
    { path: Routes.EstimatesList, name: 'Estimates', component: <L.Estimates estimates={estimates} /> },
