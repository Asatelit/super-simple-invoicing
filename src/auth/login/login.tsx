...
export const Login: React.FC<RouteComponentProps<{}, {}, LocationState>> = ({ location }) => {
  const { currentUser, signInWithEmailAndPassword } = useFirebase();
  ...
  console.info('auth.currentUser', currentUser);

  if (currentUser) return <Redirect to={location.state?.from.pathname || Routes.Dashboard} />;
      ...
      <div className={styles.container}>
        ...
        <button className="btn btn-outline-secondary btn-lg my-4">
          <div className={styles.centered}>
            ...
            <span className="small">Log in with Google</span>
          </div>
        </button>
